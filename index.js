 ...
 * @return {number} The sum of the numbers in an array
 */
function countClassesByInstructor(collection, instructors) {
  const filteredClass = _.filter(collection, { 'instructor': instructors }).length;
  return filteredClass > 0  ? filteredClass : "There is no instructor by that name."
}
